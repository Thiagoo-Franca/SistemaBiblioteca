...
public class SistemaBiblioteca {
    ...
    public static void main(String[] args) {
        ...
        Livro livro1 = fabrica.criarLivro("100", "Engenharia de Software", "Addison Wesley", List.of("Ian Sommervile"),
                "6ª", "2000");
        Livro livro2 = fabrica.criarLivro("101", "UML - Guia do Usuário", "Campus",
                List.of("Grady Booch", "James Rumbaugh", "Ivar Jacobson"),
                "7ª", "2000");
        Livro livro3 = fabrica.criarLivro("200", "Code Complete", "Microsoft Press", List.of("Steve McConnell"), "2ª",
                "2014");
        Livro livro4 = fabrica.criarLivro("201", "Agile Software Development, Principles, Patterns and Practices",
        ...
        Livro livro6 = fabrica.criarLivro("301", "Software Metrics: A rigorous and Practical Approach", "CRC Press",
